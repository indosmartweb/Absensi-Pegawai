            ...
            <div class="card-body">
                <?= form_open() ?>
                    <div class="form-group">
                        ...
                        <select id="hari" class="form-control" name="hari">
                            ...
                            <?php foreach( $hari as $h ) : ?>
                                <option value="<?php echo $i ?>"><?php echo $h ?></option>
                            <?php $i++ ?>
                            <?php endforeach ?>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="masuk_kerja" id="masuk_kerja" placeholder="Masukan Jam Masuk Kerja" value="<?= set_value('masuk_kerja') ?>">
                        <?= form_error('masuk_kerja', '<small class="text-danger">', '</small>') ?>
                    </div>
                    <div class="form-group">
                        <label for="pulang_kerja">Jam Pulang Kerja</label>
                        <input type="text" class="form-control" name="pulang_kerja" id="pulang_kerja" placeholder="Masukan Jam Pulang Kerja" value="<?= set_value('pulang_kerja') ?>">
